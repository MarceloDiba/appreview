...
**Concluído em produção em 21/08/2026.**
...
4. Revisar e fazer merge do PR temático. A migration foi aplicada em seguida,
   após o deploy automático compatível estar saudável.
