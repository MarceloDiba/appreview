  ...
  return (
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <main>
        ...
        <section id="pricing" className="scroll-mt-20 px-4 py-20 sm:px-6"><div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-8 rounded-3xl border border-violet-200 bg-violet-50/60 p-8 md:flex-row md:p-10"><div><p className="text-xs font-bold uppercase tracking-[0.16em] text-[#6D43C0]">{copy.pricing.eyebrow}</p><h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-950">{copy.pricing.title}</h2><p className="mt-3 max-w-xl text-lg leading-7 text-slate-600">{copy.pricing.body}</p></div><div className="w-full max-w-56 text-center md:text-right"><p><span className="text-5xl font-bold text-slate-950">€49</span><span className="text-slate-500">{copy.pricing.monthly}</span></p><Button asChild size="lg" className="mt-5 w-full bg-[#2457D6] hover:bg-[#1d47b0]"><Link to="/signup">{copy.pricing.cta}</Link></Button></div></div></section>
      </main>
