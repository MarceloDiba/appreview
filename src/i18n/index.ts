...
const DICTIONARY = {
  'pt-BR': {
    ...
    formContactLabel: 'WhatsApp (opcional)',
    formContactHint: 'Deixe seu WhatsApp se quiser que {business} possa te responder. Sem ele, seu recado chega, mas não tem como te retornar.',
    formContactPlaceholder: 'Seu número de WhatsApp',
    whatsappCountryLabel: 'País do WhatsApp',
  ...
  'pt-PT': {
    ...
    formContactLabel: 'WhatsApp (opcional)',
    formContactHint: 'Deixe o seu WhatsApp se quiser que {business} lhe possa responder. Sem ele, o seu recado chega, mas não há como lhe voltar.',
    formContactPlaceholder: 'O seu número de WhatsApp',
    whatsappCountryLabel: 'País do WhatsApp',
    whatsappInvalid: 'Número de WhatsApp inválido',
    formPrivacyNotice:
  ...
  en: {
    ...
    formContactLabel: 'WhatsApp (optional)',
    formContactHint: "Leave your WhatsApp if you'd like {business} to be able to reply. Without it, your message still arrives, but there's no way to get back to you.",
    formContactPlaceholder: 'Your WhatsApp number',
    whatsappCountryLabel: 'WhatsApp country',
