...
1. **Notificações:** a interface sem efeito foi removida. Para reintroduzir,
   definir eventos, canais, provedor, consentimento e tratamento de falhas; só
   então implementar entrega real e preferências persistidas.
